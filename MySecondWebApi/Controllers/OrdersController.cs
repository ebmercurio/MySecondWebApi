...
namespace MySecondWebApi.Controllers {
    ...
    public class OrdersController : ControllerBase {
        ...
        [HttpPut("approve/{id}")]
        //Task is a class. always use Task when returning stuff asynchronously
        ...
        //set to approve or rejected based on whether the total of the order is less than or equal to $100
        //if greater, set to Review
